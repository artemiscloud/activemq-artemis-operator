...
//+kubebuilder:webhook:path=/mutate-broker-amq-io-v2alpha3-activemqartemisaddress,mutating=true,failurePolicy=fail,sideEffects=None,groups=broker.amq.io,resources=activemqartemisaddresses,verbs=create;update,versions=v2alpha3,name=mactivemqartemisaddress.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-broker-amq-io-v2alpha3-activemqartemisaddress,mutating=false,failurePolicy=fail,sideEffects=None,groups=broker.amq.io,resources=activemqartemisaddresses,verbs=create;update,versions=v2alpha3,name=vactivemqartemisaddress.kb.io,admissionReviewVersions=v1
