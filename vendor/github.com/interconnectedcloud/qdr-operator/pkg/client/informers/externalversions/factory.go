...
type SharedInformerFactory interface {
	...
	Interconnectedcloud() interconnectedcloud.Interface
}

func (f *sharedInformerFactory) Interconnectedcloud() interconnectedcloud.Interface {
	return interconnectedcloud.New(f, f.namespace, f.tweakListOptions)
}
