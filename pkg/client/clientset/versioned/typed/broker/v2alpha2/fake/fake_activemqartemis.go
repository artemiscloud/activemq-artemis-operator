...
func (c *FakeActiveMQArtemises) Get(name string, options v1.GetOptions) (result *v2alpha2.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
...
func (c *FakeActiveMQArtemises) List(opts v1.ListOptions) (result *v2alpha2.ActiveMQArtemisList, err error) {
	obj, err := c.Fake.
	...
	list := &v2alpha2.ActiveMQArtemisList{}
...
func (c *FakeActiveMQArtemises) Create(activeMQArtemis *v2alpha2.ActiveMQArtemis) (result *v2alpha2.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
...
func (c *FakeActiveMQArtemises) Update(activeMQArtemis *v2alpha2.ActiveMQArtemis) (result *v2alpha2.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
...
func (c *FakeActiveMQArtemises) UpdateStatus(activeMQArtemis *v2alpha2.ActiveMQArtemis) (*v2alpha2.ActiveMQArtemis, error) {
	obj, err := c.Fake.
...
func (c *FakeActiveMQArtemises) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha2.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(activemqartemisesResource, c.ns, name, data, subresources...), &v2alpha2.ActiveMQArtemis{})
