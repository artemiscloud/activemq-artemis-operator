...
type ActiveMQArtemisInterface interface {
	Create(*v2alpha3.ActiveMQArtemis) (*v2alpha3.ActiveMQArtemis, error)
	Update(*v2alpha3.ActiveMQArtemis) (*v2alpha3.ActiveMQArtemis, error)
	UpdateStatus(*v2alpha3.ActiveMQArtemis) (*v2alpha3.ActiveMQArtemis, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v2alpha3.ActiveMQArtemis, error)
	List(opts v1.ListOptions) (*v2alpha3.ActiveMQArtemisList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha3.ActiveMQArtemis, err error)
...
func newActiveMQArtemises(c *BrokerV2alpha3Client, namespace string) *activeMQArtemises {
...
func (c *activeMQArtemises) Get(name string, options v1.GetOptions) (result *v2alpha3.ActiveMQArtemis, err error) {
	result = &v2alpha3.ActiveMQArtemis{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *activeMQArtemises) List(opts v1.ListOptions) (result *v2alpha3.ActiveMQArtemisList, err error) {
	result = &v2alpha3.ActiveMQArtemisList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) Create(activeMQArtemis *v2alpha3.ActiveMQArtemis) (result *v2alpha3.ActiveMQArtemis, err error) {
	result = &v2alpha3.ActiveMQArtemis{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) Update(activeMQArtemis *v2alpha3.ActiveMQArtemis) (result *v2alpha3.ActiveMQArtemis, err error) {
	result = &v2alpha3.ActiveMQArtemis{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) UpdateStatus(activeMQArtemis *v2alpha3.ActiveMQArtemis) (result *v2alpha3.ActiveMQArtemis, err error) {
	result = &v2alpha3.ActiveMQArtemis{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("activemqartemises").
...
func (c *activeMQArtemises) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha3.ActiveMQArtemis, err error) {
	result = &v2alpha3.ActiveMQArtemis{}
