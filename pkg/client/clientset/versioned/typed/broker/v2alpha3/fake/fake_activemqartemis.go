...
var activemqartemisesResource = schema.GroupVersionResource{Group: "broker.amq.io", Version: "v2alpha3", Resource: "activemqartemises"}

var activemqartemisesKind = schema.GroupVersionKind{Group: "broker.amq.io", Version: "v2alpha3", Kind: "ActiveMQArtemis"}
...
func (c *FakeActiveMQArtemises) Get(name string, options v1.GetOptions) (result *v2alpha3.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(activemqartemisesResource, c.ns, name), &v2alpha3.ActiveMQArtemis{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v2alpha3.ActiveMQArtemis), err
}

// List takes label and field selectors, and returns the list of ActiveMQArtemises that match those selectors.
func (c *FakeActiveMQArtemises) List(opts v1.ListOptions) (result *v2alpha3.ActiveMQArtemisList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(activemqartemisesResource, activemqartemisesKind, c.ns, opts), &v2alpha3.ActiveMQArtemisList{})
	...
	list := &v2alpha3.ActiveMQArtemisList{}
	for _, item := range obj.(*v2alpha3.ActiveMQArtemisList).Items {
...
func (c *FakeActiveMQArtemises) Create(activeMQArtemis *v2alpha3.ActiveMQArtemis) (result *v2alpha3.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(activemqartemisesResource, c.ns, activeMQArtemis), &v2alpha3.ActiveMQArtemis{})
...
func (c *FakeActiveMQArtemises) Update(activeMQArtemis *v2alpha3.ActiveMQArtemis) (result *v2alpha3.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(activemqartemisesResource, c.ns, activeMQArtemis), &v2alpha3.ActiveMQArtemis{})
...
func (c *FakeActiveMQArtemises) UpdateStatus(activeMQArtemis *v2alpha3.ActiveMQArtemis) (*v2alpha3.ActiveMQArtemis, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(activemqartemisesResource, "status", c.ns, activeMQArtemis), &v2alpha3.ActiveMQArtemis{})
...
func (c *FakeActiveMQArtemises) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(activemqartemisesResource, c.ns, name), &v2alpha3.ActiveMQArtemis{})
...
func (c *FakeActiveMQArtemises) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v2alpha3.ActiveMQArtemisList{})
	return err
}
...
func (c *FakeActiveMQArtemises) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2alpha3.ActiveMQArtemis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(activemqartemisesResource, c.ns, name, pt, data, subresources...), &v2alpha3.ActiveMQArtemis{})
